...
echo "📄 Création de admin.php dans /public..."

cat << 'PHP' > /var/www/legalshufflecam/public/admin.php
<?php
...
chmod 644 /var/www/legalshufflecam/public/admin.php
echo "✅ admin.php est prêt à être consulté sur https://legalshufflecam.ovh/admin.php"
